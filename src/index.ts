...
export const AngusModel = require('./lib/model').AngusModel;
export const AngusChaincodeError = require('./lib/error').AngusChaincodeError;
export const AngusErrorCodes = require('./lib/error').AngusErrorCodes;